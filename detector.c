...
void mycommand_detector(
    ...
    while (1) {
        ...
        sprintf(input, "dataset/test/%d.jpg", i);
        ...
        int nboxes = 0;
        detection *dets = get_network_boxes(&net, im.w, im.h, 0.5, 0.7, 0, 1, &nboxes, letter_box);
        if (nms) {
